...
# Edited by Basit & Group for major-project (educational purpose only)
...
class Kernel:
    ...
    def __init__(self):
        ...
        self._botPredicates = {}
        self.setBotPredicate("name", "SSM-BOT")
        # setting botmaster
        ...
        self.setBotPredicate("age","6 months")
        self.setBotPredicate("class","Chat-bot")
        self.setBotPredicate("master","Basit & Group")
        self.setBotPredicate("birthplace","SSM COLLEGE")
        self.setBotPredicate("location","SRINAGAR")
        ...
        self.setBotPredicate("nationality","NONE")
        self.setBotPredicate("maxclients","100")
        self.setBotPredicate("state","J AND K")
        self.setBotPredicate("country","KASHMIR")
